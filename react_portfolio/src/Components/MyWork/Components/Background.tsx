...
export function Background() {
    // return (
    // <div className={'pt-[15%] max-w-[1080px] flex place-content-center place-items-center select-none' +
    //     ' z-[-1000]'}>
    //     <div className={'w-2/5'}>
    //         <img src={character} className={'select-none absolute'} alt={'Aruksh Emoticon'}/>
    //     </div>
    // </div>
